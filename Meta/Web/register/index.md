...
To register the application you have a couple of options:

- remove the registration code and compile from source,
- have someone else remove the registration code,
- use someone else's serial key or an unofficial one or
- get an official serial key.

If the thought of pirating software would keep you up at night you can get an 
authentic key by

- emailing register |at| waechter.st with the desired user name (max. 14 characters),
- asking nicely and
- (optionally) giving me [fake Internet money](https://vrsal.cc/donate).
